...
class BrokersMembersBonusUpdateRequest extends FormRequest
{
...
//        return true;
    ...
    public function rules(): array
    {
        return [
            ...
            'member_count' => 'sometimes|required|integer',
            'bonus_per_member_per_month' => 'sometimes|required|numeric',
        ];
    }
