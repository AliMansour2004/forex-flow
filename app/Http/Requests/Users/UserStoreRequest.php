...
//        return true;
    ...
    public function rules(): array
    {
        return [
            ...
            'our_broker_account_number' => [
                'nullable',
                'integer',
                Rule::unique('users', 'our_broker_account_number'),
            ],
            'role' => [
                'required',
    ...
    public function messages()
    {
        return [
            ...
            'transaction_id.nullable' => 'The transaction ID field is optional.',
            'transaction_id.string' => 'The transaction ID must be a string.',
            'discount.nullable' => 'The discount field is optional.',
