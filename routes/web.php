...
Route::middleware('auth:sanctum')
    ->withoutMiddleware([VerifyCsrfToken::class]) // Apply here to all routes inside the group
    ->group(function () {
        Route::apiResource('users', UserController::class);
        Route::get('users_find', [UserController::class, 'find']);

        Route::apiResource('members', MemberController::class);
        Route::apiResource('members_subscriptions', MemberSubscriptionController::class);
